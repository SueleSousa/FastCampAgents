...
class Role(enum.IntFlag):
    User = 0 #inclusão de um user default como 0
    Author = 1
    Editor = 2
    Admin = 4
    SuperAdmin = 8
...
class User(BaseModel):
    ...
    #permite que o campo role seja serializado, ou seja, convertido em uma string ou JSON, por exemplo. Dessa forma o conteúdo pode ser armazenado e tranferido mais facilmente
